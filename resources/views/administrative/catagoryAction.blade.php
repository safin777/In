...
<div class="container">.
    ...
    <div class="row">
      <div class="col-lg-8 col-md-10 mx-auto">
      	...
      	<a href={{route('administrative.catagoryAction')}} class="btn btn-danger">Add Catagory</a>
      		<a href={{route('administrative.allCatagory')}} class="btn btn-info">All Catagory</a>
